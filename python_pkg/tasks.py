...
def build_quasimodo(c):
    ...
    invoke.run(
        "export BOOST_PATH=\"/mnt/e/Languages/boost/\" && cd .. && make all && cd python_pkg/ && cp ../libquasimodo.so ."
    )
    print("* Complete")
...
def compile_python_module(cpp_name, extension_name):
    invoke.run(
        "g++ -g -O3 -std=c++2a -w -shared -Wall -Wextra -DHAVE_CONFIG_H -Werror -Wunused-but-set-variable -fPIC -I/mnt/e/Languages/boost/ "
